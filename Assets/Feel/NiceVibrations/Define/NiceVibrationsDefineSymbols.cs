...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class NiceVibrationsDefineSymbols
	{
		...
		static NiceVibrationsDefineSymbols()
		{
			...
			definesList.AddRange(Symbols.Except(definesList));
			PlayerSettings.SetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(EditorUserBuildSettings.selectedBuildTargetGroup), string.Join(";", definesList.ToArray()));
#endif
		}
	}
	#endif
